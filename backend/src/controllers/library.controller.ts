 ...
 */
export const processScan = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
export const getLibraryStatusController = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    sendSuccess(res, 200, status, 'Library status retrieved successfully');
  } catch (error) {
    next(error);
  }
};
 ...
 */
export const getStudentsInsideController = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    sendSuccess(
      ...
      'Students inside retrieved successfully',
      {
 ...
 */
export const getScanLogsController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    sendSuccess(res, 200, safeLogs, 'Scan logs retrieved successfully', {
 ...
 * Get student by ID
 */
export const getStudentByIdController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    sendSuccess(res, 200, student, 'Student details retrieved successfully');
  } catch (error) {
    next(error);
  }
};
 ...
 */
export const resetSystem = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 */
export const getSeatMap = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const status = await getLibraryStatus();
    ...
    sendSuccess(res, 200, seatMapData, 'Seat map generated successfully');
  } catch (error) {
    next(error);
  }
};
